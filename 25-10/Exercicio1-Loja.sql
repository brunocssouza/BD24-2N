/*
Utilize o exemplo anterior para criar um banco de dados com clientes, produtos e pedidos. Onde a relação Produto tem (ID_Produto, Nome_Produto, Descrição, 
Preço, Qtde_Estoque) e a relação Pedido tem (ID_Pedido, ID_Cliente, ID_Produto, Qtde).
*/
